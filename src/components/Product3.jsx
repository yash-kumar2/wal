...
const Product3 = () => {
  return (
    <HStack>
      <Flex height={{ base: "auto", md: "540px" }} mt={10} justifyContent="space-evenly" w="100%" flexDirection={{ base: "column", md: "row" }} gap={{ base: 8, md: 0 }}>
        <Box w={{ base: "100%", md: "50%" }} bg="#C7D9F5" borderRadius={8} mb={{ base: 8, md: 0 }}>
          <Flex ml={5} flexDirection={{ base: "column", md: "row" }}>
            <Box>
        ...
        <Box w={{ base: "100%", md: "24%" }} mb={{ base: 8, md: 0 }}>
        ...
        <Box w={{ base: "100%", md: "20%" }} bg="#DCDDE3" borderRadius={8}>
          <Box>
          <Box mt={5} ml={5}>
