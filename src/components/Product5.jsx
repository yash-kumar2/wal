import {
  ...
  const Product5 = () => {
    ...
    return (
      <>
        <HStack mt={{ base: 8, md: 20 }} w="100%">
          <Flex w="100%" justifyContent="space-evenly" flexDirection={{ base: "column", md: "row" }} gap={{ base: 8, md: 0 }}>
            ...
            <Box bg="green" w={{ base: "100%", md: "48%" }} bgImage={boyAndGirl} height={{ base: "250px", md: "400px" }} borderRadius={8} mt={{ base: 8, md: 0 }}>
